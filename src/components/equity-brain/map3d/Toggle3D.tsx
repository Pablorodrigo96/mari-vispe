...
export function Toggle3D({ mode, onChange }: Props) {
  return (
    <div className="absolute top-3 right-3 z-[600] flex items-center gap-0.5 p-0.5 rounded-md bg-zinc-900/80 backdrop-blur-md border border-zinc-800 shadow-lg">
