...
export function AppTopbar({ onMenuClick }: Props) {
  ...
  return (
    <header className="sticky top-0 z-20 h-14 border-b border-border bg-background/80 backdrop-blur-lg">
      <div className="h-full px-4 lg:px-6 flex items-center justify-between gap-3">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <nav className="flex items-center gap-1.5 text-sm min-w-0">
            <Link to="/painel" className="text-muted-foreground hover:text-foreground hidden sm:inline">PME.B3</Link>
        ...
        <div className="flex items-center gap-2">
          <div className="hidden md:flex items-center gap-2 h-8 px-3 rounded-lg border border-border bg-muted/30 text-xs text-muted-foreground w-64">
